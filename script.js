...
(function () {
  ...
  const T = {
    de: {
      ...
      'exp-pit-title': 'Praktikum Informationstechnik 1 – Autonomes Fahren',
      'exp-pit-1': 'Entwicklung einer modularen C++-Klassenbibliothek (Common_Classes) für ein autonomes Modellfahrzeug auf Basis des TI Tiva C (TM4C123GH6PM); verantwortlich für Ultraschall-Distanzsensorik (HC-SR04) und Lenkungssteuerung.',
      'exp-pit-2': 'Klassenbasierte Treiberentwicklung (System, GPIO, ADC, Timer, UART, Distance, Steering) mit Testprogramm je Klasse; Integration im Team über ein gemeinsames Git-Repository (Gruppe 066).',
      'exp-pit-more': 'Projektdetails →',
      'proj-title': 'Projekte',
    ...
    en: {
      ...
      'exp-pit-title': 'Lab Course Information Technology 1 – Autonomous Driving',
      'exp-pit-1': 'Development of a modular C++ class library (Common_Classes) for an autonomous model vehicle based on the TI Tiva C (TM4C123GH6PM); responsible for ultrasonic distance sensing (HC-SR04) and steering control.',
      'exp-pit-2': 'Class-based driver development (System, GPIO, ADC, Timer, UART, Distance, Steering) with a test program per class; team integration via a shared Git repository (Group 066).',
      'exp-pit-more': 'Project details →',
      'proj-title': 'Projects',
    ...
    zh: {
      ...
      'exp-pit-title': '信息技术 1 实验课 – 自动驾驶',
      'exp-pit-1': '基于 TI Tiva C（TM4C123GH6PM）为自动驾驶模型车开发模块化 C++ 类库（Common_Classes）；负责超声波测距（HC-SR04）与转向控制。',
      'exp-pit-2': '基于类的驱动开发（System、GPIO、ADC、Timer、UART、Distance、Steering），每个类配有测试程序；通过小组共享 Git 仓库（第 066 组）完成团队集成。',
      'exp-pit-more': '项目详情 →',
      'proj-title': '个人项目',
